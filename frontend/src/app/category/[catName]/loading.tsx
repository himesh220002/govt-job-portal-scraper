    ...
    <main className="min-h-screen bg-slate-50">
      <div className="relative overflow-hidden bg-[#050914] text-white">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 py-10 sm:py-14 text-center">
          ...
          <div className="mx-auto mt-5 h-10 w-56 animate-pulse rounded-xl bg-white/10" />
          <div className="mx-auto mt-3 h-4 w-72 animate-pulse rounded-full bg-white/10" />
          <div className="mx-auto mt-4 h-6 w-32 animate-pulse rounded-full bg-white/10" />
        </div>
      </div>
