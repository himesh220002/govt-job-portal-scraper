  ...
  return (
    <form onSubmit={handleSearch} className="relative group w-full max-w-lg mx-auto">
      ...
      <input
        ...
        className={`w-full rounded-full pl-13 pr-36 py-3 sm:py-4 outline-none text-xs sm:text-base transition-all duration-300 shadow-lg ${isDark
      ...
      <button
        type="submit"
        className={`absolute right-1.5 top-1/2 -translate-y-1/2 flex items-center gap-2 rounded-full px-4 sm:px-6 py-1.5 sm:py-2.5 font-semibold text-sm transition-all duration-300 shadow-md ${isDark
